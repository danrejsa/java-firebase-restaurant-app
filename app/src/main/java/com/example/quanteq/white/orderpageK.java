...
public class orderpageK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderpage_k);
        ...
        mDatabase.child(food_Key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(orderpageK.this).load(food_image).into(singleFoodImage);
            }
    ...
    public void orderItemClicked(View view) {
        ...
        if (TextUtils.isEmpty(location_text) && TextUtils.isEmpty(location2_text)) {
            Toast.makeText(orderpageK.this, "Please enter Home Address or Table number!", Toast.LENGTH_LONG).show();
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    newPost.child("Username").setValue(dataSnapshot.child("Name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(orderpageK.this, "Successful", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
