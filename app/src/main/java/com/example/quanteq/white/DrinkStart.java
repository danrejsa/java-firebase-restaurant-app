 ...
 * {@link DrinkStart.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DrinkStart#newInstance} factory method to
 * create an instance of this fragment.
 *
 *
 *
 */public class DrinkStart extends Fragment {
    ...
    private DrinkStart.OnFragmentInteractionListener mListener;
     ...
     * @return A new instance of fragment DrinkStart.
     */
    // TODO: Rename and change types and number of parameters
    public static DrinkStart newInstance(String param1, String param2) {
        DrinkStart fragment = new DrinkStart();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // startActivity(tap);
        View view = inflater.inflate(R.layout.fragment_drink_start, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recApps= (RecyclerView)getActivity().findViewById(R.id.recApp);
        recApps.setHasFixedSize(true);
        recApps.setLayoutManager(new LinearLayoutManager(getActivity()));
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Drink");
            ...
            protected void populateViewHolder(Nenupage.FoodViewHolder viewHolder, Foot model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       // Intent single = new Intent(getActivity(), orderpageK.class);
