...
public class Orderpage extends AppCompatActivity {
    ...
    private String food_Key,food_Key2 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child(food_Key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(Orderpage.this).load(food_image).into(singleFoodImage);
            }
    ...
    public void orderItemClicked(View view) {
        ...
        if (TextUtils.isEmpty(location_text) && TextUtils.isEmpty(location2_text)) {
            Toast.makeText(Orderpage.this, "Please enter Home Address or Table number!", Toast.LENGTH_LONG).show();
            ...
            userData.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    newPost.child("username").setValue(dataSnapshot.child("Name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(Orderpage.this, "Successful", Toast.LENGTH_SHORT).show();
                            Intent i = new Intent(Orderpage.this, welcome.class);
                            st = mlocation.getText().toString();
                            i.putExtra("Value", st);
                            startActivity(i);
                            finish();
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(Orderpage.this, "Fail to submit", Toast.LENGTH_SHORT).show();
                }
            });
