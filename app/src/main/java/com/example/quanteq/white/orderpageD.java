...
public class orderpageD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderpage_d);
        ...
        mDatabase.child(food_Key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(orderpageD.this).load(food_image).into(singleFoodImage);
            }
    ...
    public void orderItemClicked(View view) {
        ...
        if (TextUtils.isEmpty(location_text) && TextUtils.isEmpty(location2_text)) {
            Toast.makeText(orderpageD.this, "Please enter Home Address or Table number!", Toast.LENGTH_LONG).show();
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    newPost.child("Username").setValue(dataSnapshot.child("Name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(orderpageD.this, "Successful", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
